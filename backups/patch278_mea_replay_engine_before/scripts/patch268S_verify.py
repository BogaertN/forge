#!/usr/bin/env python3
"""Patch 268S Verifier. Run: python scripts/patch268S_verify.py"""
...
b = boundary()
chk("engine_268S",             "268S" in ENGINE_VERSION)
...
r = probe_protoforge2_status("/tmp/pf2_268S_verify_missing")
...
# Behavior tests
r_bt = subprocess.run([sys.executable, "scripts/test_patch268S_pf2_drift_adapter.py"],
...
if failed==0: print("\nRESULT: PATCH_268S_VERIFY_OK"); sys.exit(0)
else: print(f"\nRESULT: PATCH_268S_VERIFY_FAIL ({failed})"); sys.exit(1)

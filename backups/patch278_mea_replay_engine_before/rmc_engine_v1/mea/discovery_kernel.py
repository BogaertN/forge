...
Patch 277 — MEA / Forge Discovery Kernel Scoring Foundation Identity.
...
writer. Patch 277 is not that full runtime. It extends the stable kernel foundation
with read-only convergence, goal ancestry, and operator cost scoring surfaces.
"""
...
KERNEL_STAGE = "scoring_foundation_read_only_patch277"
KERNEL_PATCH_ID = "Patch 277 — MEA Convergence / Ancestry / Cost Scoring"
...
class KernelBoundary:
    """Immutable boundary declaration for the Patch 277 kernel surface."""

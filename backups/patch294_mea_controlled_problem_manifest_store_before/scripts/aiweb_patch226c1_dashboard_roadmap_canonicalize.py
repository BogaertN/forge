...
CANONICAL_ENTRIES = [
    {"id": "S19AC", "status": "DONE", "title": "Identity Vault Profile Seed Preview / Template Repair Gate"},
...
def patch_text(text: str) -> Tuple[str, List[str]]:
    ...
    replacements = {
        "Dashboard Roadmap Panel Status — Patch 226C.1": "Dashboard Roadmap Panel Status — Patch 226C.1",
        "Dashboard Roadmap Panel List — Patch 226C.1": "Dashboard Roadmap Panel List — Patch 226C.1",
        "Current    : S19AT — Identity Vault Profile Seed Preview / Template Repair Gate": "Current    : S19AT — Identity Vault Profile Seed Preview / Template Repair Gate",
        "Next patch : Patch 226D — Identity Vault Template Repair Preview / No-Write JSON Repair Review": "Next patch : Patch 226D — Identity Vault Template Repair Preview / No-Write JSON Repair Review",
        "S19AC DONE     Runtime Candidate Sandbox Stage Create/Verify / Forge-Owned Copy Only": "S19AC DONE     Runtime Candidate Sandbox Stage Create/Verify / Forge-Owned Copy Only",
        "S19AD DONE     Runtime Candidate Sandbox Copy Integrity Review / No-Write Readback Receipt": "S19AD DONE     Runtime Candidate Sandbox Copy Integrity Review / No-Write Readback Receipt",
    }
    ...
    compact_replacements = {
        '"current": "S19AT"': '"current": "S19AT"',
        "'current': 'S19AT'": "'current': 'S19AT'",
        '"next_patch": "Patch 226D"': '"next_patch": "Patch 226D"',
        "'next_patch': 'Patch 226D'": "'next_patch': 'Patch 226D'",
        '"Identity Vault Profile Seed Preview / Template Repair Gate"': '"Identity Vault Profile Seed Preview / Template Repair Gate"',
        "'Identity Vault Profile Seed Preview / Template Repair Gate'": "'Identity Vault Profile Seed Preview / Template Repair Gate'",
    }

...
Patch 293 — MEA / Forge Discovery Kernel Live Manifest Advance Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 293 adds a deterministic live-manifest advance preview from the accepted response-only sealed-candidate object, but cannot execute /api/mea/seal, advance live state, persist a manifest, or write memory.
"""
...
KERNEL_STAGE = "manifest_advance_preview_patch293"
KERNEL_PATCH_ID = "Patch 293 — MEA Live Manifest Advance Preview"
...
class ForgeDiscoveryKernelFoundation:
    ...
    def identity(self) -> Dict[str, Any]:
        return {
            ...
            "manifest_persistence_active": False,
            "score_can_rank": True,

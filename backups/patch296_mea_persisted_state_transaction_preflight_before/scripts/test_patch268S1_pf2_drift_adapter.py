#!/usr/bin/env python3
"""Patch 268S1 — ProtoForge2 Drift Candidate Adapter Tests.
Run: python scripts/test_patch268S1_pf2_drift_adapter.py
"""
...
b = boundary()
chk("T1_engine_268S1",          "268S1" in b["engine_version"])
...
r = probe_protoforge2_status("/tmp/pf2_definitely_missing_268S1")
...
if failed == 0:
    print("\n  RESULT: patch268S1_tests=PASS"); sys.exit(0)
else:
    print("\n  RESULT: patch268S1_tests=FAIL"); sys.exit(1)

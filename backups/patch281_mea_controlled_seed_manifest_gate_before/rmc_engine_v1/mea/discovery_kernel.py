...
Patch 280 — MEA / Forge Discovery Kernel Read-Only API Visibility Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 280 still does not run the full MEA
problem-evolution runtime: no live problem seeding, no candidate sealing, no
memory promotion, no LLM calls, no shell execution, and no UI mutation.
"""
...
KERNEL_STAGE = "read_only_api_visibility_patch280"
KERNEL_PATCH_ID = "Patch 280 — MEA Read-Only API / Operator Console Visibility"
    ...
    def identity(self) -> Dict[str, Any]:
        return {
            ...
            "next_runtime_layers": [
                ...
                "Patch 281 controlled seed manifest preview/gate — not installed",
            ],

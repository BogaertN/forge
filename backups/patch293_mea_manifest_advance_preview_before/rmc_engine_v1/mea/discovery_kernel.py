...
Patch 292 — MEA / Forge Discovery Kernel Controlled Seal Candidate Gate Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 292 adds a controlled seal-candidate gate that can return a sealed-candidate preview object in the response only, but cannot execute /api/mea/seal, advance live state, or write memory.
"""
...
KERNEL_STAGE = "seal_candidate_gate_preview_patch292"
KERNEL_PATCH_ID = "Patch 292 — MEA Controlled Seal Candidate Gate"

    ...
    try:
        while True:
            ...
            if user_input.lower() == "help":
                ...
                print()
                print("  Level 2.0 patch workflow:")
                print("    forge> patch-propose ~/forge_test_project/test.txt")
                print("    [fill in fields interactively]")
                print("    [proposal appears in ~/forge/proposed_patches/]")
                print("    [target file is NEVER modified]")
                print()

...
KERNEL_STAGE = "hard_gate_report_preview_patch283"
KERNEL_PATCH_ID = "Patch 283 — MEA Hard Gate Report / Candidate Gate Engine Preview"
    ...
    def identity(self) -> Dict[str, Any]:
        return {
            ...
            "next_runtime_layers": [
                ...
                "Patch 283 hard gate report — installed non-mutating approval-token POST",
            ],

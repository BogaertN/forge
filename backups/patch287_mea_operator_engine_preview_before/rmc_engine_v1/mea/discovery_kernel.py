...
Patch 286 — MEA / Forge Discovery Kernel Seal Packet Audit Chain Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 286 adds a non-mutating seal-packet audit-chain preview over seal-packet reports. It still does not
...
KERNEL_STAGE = "seal_packet_audit_chain_preview_patch286"
KERNEL_PATCH_ID = "Patch 286 — MEA Seal Packet Audit Chain / Hash Stability Ledger Preview"

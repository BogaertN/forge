...
Patch 289 — MEA / Forge Discovery Kernel Coherence Extension Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 289 adds a non-mutating coherence scoring adapter that ranks generated candidates while proving score cannot override hard gates. It still does not
...
KERNEL_STAGE = "coherence_extension_preview_patch289"
KERNEL_PATCH_ID = "Patch 289 — MEA Coherence Scorer Extension Preview"

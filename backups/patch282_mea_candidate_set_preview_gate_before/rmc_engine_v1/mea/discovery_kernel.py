...
Patch 281 — MEA / Forge Discovery Kernel Controlled Seed Gate Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 281 adds a controlled seed-manifest gate, but it still does not
commit live MEA state: no live problem seeding persistence, no candidate
sealing, no memory promotion, no LLM calls, no shell execution, and no UI
mutation.
"""
...
KERNEL_STAGE = "controlled_seed_manifest_gate_patch281"
KERNEL_PATCH_ID = "Patch 281 — MEA Controlled Seed Manifest Gate"
    ...
    def identity(self) -> Dict[str, Any]:
        return {
            ...
            "next_runtime_layers": [
                ...
                "Patch 282 candidate set preview/gate — not installed",
            ],

#!/usr/bin/env python3
"""Patch 284R verifier — MEA Seal Readiness Route Dispatch Hotfix."""
...
PATCH = "Patch 284R — MEA Seal Readiness Route Dispatch Hotfix"
...
print("PATCH 284R VERIFIER — MEA Seal Readiness Route Dispatch Hotfix")
...
check("main_get_dispatch_seal_readiness_status", "def _p284_mea_seal_readiness_status_v1" in main_text and "/api/mea/seal-readiness/status" in main_text)
check("main_get_dispatch_seal_readiness_preview", "def _p284_mea_seal_readiness_preview_v1" in main_text and "/api/mea/seal-readiness-preview" in main_text)
check("main_post_dispatch_seal_readiness", "def _p284_mea_seal_readiness_gate_post_v1" in main_text and "/api/mea/seal-readiness-gate" in main_text)
...
print(f"RESULT: PATCH_284R_VERIFY {'PASS' if fails == 0 else 'FAIL'}  Total:{passes+fails} Passed:{passes} Failed:{fails}")

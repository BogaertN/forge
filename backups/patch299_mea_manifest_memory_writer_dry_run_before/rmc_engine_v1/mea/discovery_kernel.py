...
Patch 298 — MEA / Forge Discovery Kernel Live Trace Replay Verification Identity.
...
reconstructing it from the rollback-embedded source state. The canonical
...
KERNEL_STAGE = "live_trace_replay_verification_patch298"
KERNEL_PATCH_ID = "Patch 298 — MEA Live Trace Replay Verification"

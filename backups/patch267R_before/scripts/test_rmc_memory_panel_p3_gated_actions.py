#!/usr/bin/env python3
"""Behavior checks for Patch 262-UI-MemoryPanel-P3.
...
node_code = f'''
import {{ evaluatePromotionArmState, buildPromotionConfirmationPhrase, PROMOTION_TOKEN }} from {json.dumps(GUARDS_JS.as_uri())};
const preview = {{
...
if fails:
    print("RESULT: rmc_memory_panel_p3_gated_actions_tests_pass=False")
    raise SystemExit(1)
print("RESULT: rmc_memory_panel_p3_gated_actions_tests_pass=True")

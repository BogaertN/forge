#!/usr/bin/env python3
"""Patch 284R behavior tests — MEA Seal Readiness Preview."""
...
print("PATCH 284R BEHAVIOR TESTS — MEA Seal Readiness Route Dispatch Hotfix")
print(f"Forge root: {ROOT}")

check("patch_id_locked", SEAL_READINESS_PATCH_ID == "Patch 284R — MEA Seal Readiness Route Dispatch Hotfix", SEAL_READINESS_PATCH_ID)
...
print(f"RESULT: PATCH_284R_BEHAVIOR {'PASS' if fails == 0 else 'FAIL'}  Total:{passes+fails} Passed:{passes} Failed:{fails}")

...
Patch 297 — MEA / Forge Discovery Kernel Controlled Atomic Advance Identity.
...
transaction preflight trace, and Patch 297 adds the first controlled atomic
candidate-driven manifest transition. The canonical /api/mea/seal route remains
...
KERNEL_STAGE = "controlled_atomic_seal_manifest_advance_commit_patch297"
KERNEL_PATCH_ID = "Patch 297 — MEA Controlled Atomic Seal / Manifest Advance Commit"

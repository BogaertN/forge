...
export type RmcRouteKey =
  ...
  | 'containment_router'
  | 'spc_cold_storage_preview'
  | 'drift_archive_preview'
  | 'dream_state_preview'
  | 'ghost_loop_preview'
  | 'chi_correction_preview'
  | 'protoforge2_drift_status'
  | 'protoforge2_drift_preview'
  | 'resurrection_preview'
  | 'deep_pipeline_preflight'
  | 'deep_dry_run';
...
export interface RmcRequestParams {
  ...
  scenario?: string;
  scenario_id?: string;
  use_protoforge2_preview?: boolean | string;
  render_mode?: string;
  phase?: string;
...
const FALLBACK_ROUTES: Record<RmcRouteKey, string> = {
  ...
  spc_cold_storage_preview: '/api/rmc/spc-cold-storage/preview',
  drift_archive_preview: '/api/rmc/drift-archive/preview',
  dream_state_preview: '/api/rmc/dream-state/preview',
  ghost_loop_preview: '/api/rmc/ghost-loop/preview',
  chi_correction_preview: '/api/rmc/chi-correction-preview',
  protoforge2_drift_status: '/api/rmc/protoforge2-drift-status',
...
export const getContainmentRouter = (params: RmcRequestParams = {}) => fetchRmcEndpoint('containment_router', params);
export const getSpcColdStoragePreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('spc_cold_storage_preview', params);
export const getDriftArchivePreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('drift_archive_preview', params);
export const getDreamStatePreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('dream_state_preview', params);
export const getGhostLoopPreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('ghost_loop_preview', params);
export const getChiCorrectionPreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('chi_correction_preview', params);
export const getProtoForge2DriftStatus = () => fetchRmcEndpoint('protoforge2_drift_status');
export const getProtoForge2DriftPreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('protoforge2_drift_preview', params);
export const getResurrectionPreview = (params: RmcRequestParams = {}) => fetchRmcEndpoint('resurrection_preview', params);
export const getDeepPipelinePreflight = () => fetchRmcEndpoint('deep_pipeline_preflight');
export const getDeepDryRun = (params: RmcRequestParams = {}) => fetchRmcEndpoint('deep_dry_run', params);

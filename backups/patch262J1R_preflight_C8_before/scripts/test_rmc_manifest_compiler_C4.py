...
def main() -> int:
    ...
    _assert("schema_required_fields", set(schema.get("required_fields", [])) == {"claim", "phase_path", "operator_path", "memory_links", "confidence", "novelty", "drift_status", "output_targets"})

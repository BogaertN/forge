...
Patch 288 — MEA / Forge Discovery Kernel Candidate Generator Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 288 adds a non-mutating candidate-generator preview that verifies Patch 287 drafts into uncommitted candidate previews c_i. It still does not
...
KERNEL_STAGE = "candidate_generator_preview_patch288"
KERNEL_PATCH_ID = "Patch 288 — MEA Candidate Generator Runtime Preview"

...
def _print_banner(session_id: str, scope: list[str]):
    print()
    print("┌─────────────────────────────────────────────────────┐")
    print("│  FORGE  —  Local Coding Assistant  —  Level 0.7    │")
    print("│  Manual Diagnostic Loop.                            │")
    print("│  Forge proposes. Nic runs. Nic pastes. Forge reads. │")
    ...
    print("  'status' — config. 'audit' — log integrity. 'diag <cmd>' — paste terminal output.")
    print()
        ...
        while True:
            ...
            if user_input.lower().startswith("diag "):
                ...
                if not diag_command:
                    ...
                    print("  Example: diag df -h")
                    print("  Example: diag git status")
                    print()
                else:
            ...
            if user_input.lower() == "help":
                ...
                print("    diag <command>    — paste multi-line terminal output for analysis")
                print("    quit              — end session")
                print()
                print("  diag example:")
                print("    forge> diag free -h")
                print("    Paste the terminal output, then type END on its own line.")
                print()

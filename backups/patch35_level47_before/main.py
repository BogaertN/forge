...
def _print_banner(session_id: str, scope: list[str]):
    print()
    print("┌─────────────────────────────────────────────────────┐")
    print("│  FORGE  —  Local Coding Assistant  —  Level 4.6    │")
    print("│  Multi-Corpus Knowledge Planning Layer.             │")
    print("│  corpus-list/status/show/check/policy.              │")
    print("└─────────────────────────────────────────────────────┘")
...
_CORPUS_POLICY_RULES = [
    ...
    "8. Public/business docs (01_SYSTEM_LAW) — only for public/business writing",

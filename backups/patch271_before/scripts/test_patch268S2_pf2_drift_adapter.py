#!/usr/bin/env python3
"""Patch 268S2 — ProtoForge2 Drift Candidate Adapter Tests.
Run: python scripts/test_patch268S2_pf2_drift_adapter.py
"""
...
b = boundary()
chk("T1_engine_268S2",          "268S2" in b["engine_version"])
...
r = probe_protoforge2_status("/tmp/pf2_definitely_missing_268S2")
...
if failed == 0:
    print("\n  RESULT: patch268S2_tests=PASS"); sys.exit(0)
else:
    print("\n  RESULT: patch268S2_tests=FAIL"); sys.exit(1)

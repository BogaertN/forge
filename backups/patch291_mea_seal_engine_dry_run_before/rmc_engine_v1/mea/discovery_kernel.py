...
Patch 290 — MEA / Forge Discovery Kernel Gate Engine Extension Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 290 adds a reusable MEA gate engine over generated candidates. Scores still rank only; gates remain authoritative. It does not commit live MEA state, seal candidates, promote memory, call an LLM, execute shell commands, or mutate UI/launcher behavior.
"""
...
KERNEL_STAGE = "gate_engine_preview_patch290"
KERNEL_PATCH_ID = "Patch 290 — True MEA Gate Engine Extension Preview"

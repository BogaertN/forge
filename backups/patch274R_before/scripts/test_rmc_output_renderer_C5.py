...
def main() -> int:
    ...
    _assert("sentence_plan_present", isinstance((rendered.get("render_packet") or {}).get("sentence_plan"), dict) and (rendered.get("render_packet") or {}).get("sentence_plan_validation", {}).get("passed") is True)

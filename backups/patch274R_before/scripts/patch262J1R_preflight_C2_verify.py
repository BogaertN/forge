...
def main() -> int:
    ...
    check("test_rmc_evolutionary_drift_coherence_C2.py_passes", ok and "evolutionary_drift_coherence_C2R_behavior_tests_pass=True" in out, out)
    ...
    print("PATCH 262J1R-PREFLIGHT-C2 VERIFY (C2R COMPAT)")
    print("─" * 72)
    failed = 0

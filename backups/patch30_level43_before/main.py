...
def _print_banner(session_id: str, scope: list[str]):
    print()
    print("┌─────────────────────────────────────────────────────┐")
    print("│  FORGE  —  Local Coding Assistant  —  Level 4.2    │")
    print("│  Rollback Restore + Session-End Audit.              │")
    print("│  Type RESTORE to undo. Full audit trail.            │")
    print("└─────────────────────────────────────────────────────┘")
    ...
    try:
        while True:
            ...
            if user_input.lower() == "help":
                ...
                print("    rollback-restore <rollback_file>  — restore from rollback snapshot (type RESTORE to confirm)")

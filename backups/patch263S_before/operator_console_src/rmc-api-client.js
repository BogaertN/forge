...
export const getMemoryObject = (params = {}) => fetchRmcEndpoint('memory_object', params);
export const getContextSearchTest = (params = {}) => fetchRmcEndpoint('context_search_test', params);
...
export const getLatestMemoryWrites = (params = {}) => fetchRmcEndpoint('latest_memory_writes', params);

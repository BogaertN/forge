...
Patch 279 — MEA / Forge Discovery Kernel Claim Status Foundation Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 279 still does not run the full MEA
...
KERNEL_STAGE = "claim_status_foundation_read_only_patch279"
KERNEL_PATCH_ID = "Patch 279 — MEA Claim Status Classifier"
...
class KernelBoundary:
    """Immutable boundary declaration for the Patch 279 kernel surface."""

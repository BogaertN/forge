#!/usr/bin/env python3
"""Verifier for Patch 262J1R-Preflight-C1 — Candidate Generator Route/Test Repair."""
...
def main() -> int:
    ...
    check("main_has_patch_C_label", "Patch 262J1R-Preflight-C1" in main_text)
    ...
    check("main_candidate_alias_dispatch_present", 'elif _p249_req_path == "/api/rmc/candidate-generator"' in main_text)
    ...
    print("PATCH 262J1R-PREFLIGHT-C1 VERIFY")
    print("─" * 72)
    failed = 0
    ...
    if failed:
        print("RESULT: PATCH_262J1R_PREFLIGHT_C1_VERIFY_FAILED")
        return 1
    print("RESULT: PATCH_262J1R_PREFLIGHT_C1_VERIFY_OK")
    return 0

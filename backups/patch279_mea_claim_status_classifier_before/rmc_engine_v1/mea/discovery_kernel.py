...
Patch 278 — MEA / Forge Discovery Kernel Replay Foundation Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 278 still does not run the full MEA
...
KERNEL_STAGE = "replay_foundation_read_only_patch278"
KERNEL_PATCH_ID = "Patch 278 — MEA Replay Engine"
...
class KernelBoundary:
    """Immutable boundary declaration for the Patch 278 kernel surface."""

...
ENGINE_VERSION = "rmc_deep_dry_run_orchestrator_v1_patch271"
...
def boundary() -> dict[str, Any]:
    return {
        ...
        "description": "Read-only full-stack RMC dry-run orchestrator. Proves cross-module routing without activation.",
...
def run_deep_dry_run(
    ...
    *,
    ...
    approved output.
    """
    source_text = str(source_text or DEFAULT_DRY_RUN_TEXT)
    source_metadata = dict(source_metadata or {})
    source_metadata.setdefault("source", "patch271_deep_dry_run")

...
def _print_banner(session_id: str, scope: list[str]):
    print()
    print("┌─────────────────────────────────────────────────────┐")
    print("│  FORGE  —  Local Coding Assistant  —  Level 3.0    │")
    print("│  Rollback Registry + Apply Preflight.               │")
    print("│  Forge plans. Rollback saved. Nic applies.          │")
    print("└─────────────────────────────────────────────────────┘")
...
def cmd_patch_preflight(
    ...
    print(f"[forge] This will:")
    print(f"  1. Validate the proposal and target file")
    print(f"  2. Confirm original snippet exists in target")
    print(f"  3. Save rollback snapshot → ~/forge/rollback_registry/")
    print(f"  4. Save apply plan       → ~/forge/apply_plans/")
    print(f"  5. Audit PATCH_APPLY_PLAN_CREATED")
    ...
    try:
        while True:
            ...
            if user_input.lower() == "help":
                ...
                print()
                print("  Level 3.0 full patch workflow:")
                ...
                print("    [Nic edits file manually using apply plan as guide]")
                print()

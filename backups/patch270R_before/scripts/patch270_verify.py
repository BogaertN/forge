#!/usr/bin/env python3
"""Patch 270 Verifier. Run: python scripts/patch270_verify.py"""
...
print(f"\nPATCH 270 VERIFIER  Total:{len(results)} Passed:{passed} Failed:{failed}")
if failed==0: print("RESULT: PATCH_270_VERIFY_OK"); sys.exit(0)
else: print(f"RESULT: PATCH_270_VERIFY_FAIL ({failed})"); sys.exit(1)

...
Patch 296 — MEA / Forge Discovery Kernel Persisted-State Transaction Preflight Identity.
...
manifest; Patch 296 binds one explicitly submitted candidate to the persisted
...
KERNEL_STAGE = "persisted_state_transaction_preflight_patch296"
KERNEL_PATCH_ID = "Patch 296 — MEA Persisted-State Seal / Advance Transaction Preflight"

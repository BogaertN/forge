...
Patch 291 — MEA / Forge Discovery Kernel Seal Engine Dry-Run Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 291 adds a dry-run seal engine that can compile a future seal object shape but cannot execute /api/mea/seal, advance live state, or write memory.
"""
...
KERNEL_STAGE = "seal_engine_dry_run_patch291"
KERNEL_PATCH_ID = "Patch 291 — MEA Seal Engine Dry-Run"

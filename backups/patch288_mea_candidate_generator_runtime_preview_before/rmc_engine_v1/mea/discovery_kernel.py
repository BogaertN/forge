...
Patch 287 — MEA / Forge Discovery Kernel Operator Engine Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 287 adds a non-mutating operator-engine preview that produces unverified drafts d_i. It still does not
...
KERNEL_STAGE = "operator_engine_preview_patch287"
KERNEL_PATCH_ID = "Patch 287 — MEA Operator Engine Preview"

...
def _print_banner(session_id: str, scope: list[str]):
    ...
    print("│  Phase D Grounding Required Before Patch.        │")
    print("│  ground first | propose second | receipt checked │")
    print("└─────────────────────────────────────────────────────┘")
    ...
    try:
        while True:
            ...
            if user_input.lower() == "help":
                ...
                print("    patch-propose <file>          ← create proposal only after grounding PASS")

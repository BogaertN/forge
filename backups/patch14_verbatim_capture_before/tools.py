    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "This tool stores the output, audits the receipt, and prepares it for your analysis. "
                "After calling this tool, analyze the output and explain what it means. "
                "If a next diagnostic step is needed, call propose_command afterward. "
                "NEVER call this for output you invented or assumed — only for actual output Nic pasted."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "output": {
                        "type": "string",
                        "description": "The exact terminal output Nic pasted. Do not modify or truncate it."
                    },
                    "context": {
                        "type": "string",
...
def dispatch(tool_name: str, args: dict, session_id: str = "unknown", user_question: str = "") -> dict:
    ...
    if tool_name == "list_allowed_folders":
        ...
        return _err(
            ...
            "search_text, search_knowledge_base, propose_command, analyze_command_output"
        )

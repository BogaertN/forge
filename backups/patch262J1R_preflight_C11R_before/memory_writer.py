...
GATED_ENGINE_VERSION = "rmc_gated_memory_writer_v1_patch262J1R_preflight_C8"
...
def _commit_paths(root: _Path, write_class: str, memory_node_id: str, day: str | None = None) -> dict[str, _Path]:
...
def commit_memory_write(
    ...
    paths = _commit_paths(root, write_class, str(memory_node["memory_node_id"]))

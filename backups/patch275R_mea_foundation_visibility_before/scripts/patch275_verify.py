...
def main() -> int:
    ...
    print("PATCH 275 VERIFIER — MEA / Forge Discovery Kernel Foundation")
    ...
    for rel in ("rmc_engine_v1/mea/manifest_schema.py", "rmc_engine_v1/mea/unknown_detector.py", "rmc_engine_v1/mea/__init__.py"):
    ...
    print(f"RESULT: PATCH_275_VERIFY {'PASS' if failed == 0 else 'FAIL'}  Total:{len(results)} Passed:{passed} Failed:{failed}")

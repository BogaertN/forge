...
Patch 285 — MEA / Forge Discovery Kernel Seal Packet Preview Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 285 adds a non-mutating seal-packet preview over seal-readiness reports. It still does not
...
KERNEL_STAGE = "seal_packet_preview_patch285"
KERNEL_PATCH_ID = "Patch 285 — MEA Seal Packet Preview / Future Seal Payload Normalizer"

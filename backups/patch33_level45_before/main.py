...
def _print_banner(session_id: str, scope: list[str]):
    print()
    print("┌─────────────────────────────────────────────────────┐")
    print("│  FORGE  —  Local Coding Assistant  —  Level 4.4    │")
    print("│  Post-Write Fresh Readback + Field Report.          │")
    print("│  No stale context after writes. field-report cmd.   │")
    print("└─────────────────────────────────────────────────────┘")
    ...
    try:
        while True:
            ...
            if user_input.lower() == "help":
                ...
                print("    field-report <file_or_target>    — full lifecycle summary (read-only)")

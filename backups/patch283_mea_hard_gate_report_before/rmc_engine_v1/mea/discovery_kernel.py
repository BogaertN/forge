...
Patch 282 — MEA / Forge Discovery Kernel Candidate Set Preview/Gate Identity.

This module exposes the Forge Discovery Kernel as a read-only foundation surface
with deterministic replay support. Patch 282 adds a non-mutating candidate-set preview/gate. It still does not
...
KERNEL_STAGE = "candidate_set_preview_gate_patch282"
KERNEL_PATCH_ID = "Patch 282 — MEA Candidate Set Preview/Gate"

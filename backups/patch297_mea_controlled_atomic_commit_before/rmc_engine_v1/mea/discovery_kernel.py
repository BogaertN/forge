...
Patch 296R — MEA / Forge Discovery Kernel Transaction Trace Source-Binding Identity.

This module exposes the Forge Discovery Kernel with deterministic replay support.
Patch 294 owns approved initial-seed-only persistent problem-manifest state;
Patch 295 exposes read-only candidates generated from that verified stored
manifest; Patch 296R binds one explicitly submitted candidate to the persisted
state, gate report, seal-packet preview, audit-chain preview, proposed manifest
advance, receipt preview, and rollback preview without executing any mutation.
It cannot execute /api/mea/seal, commit a candidate, advance live state from a
candidate, or write memory.
"""
...
KERNEL_STAGE = "persisted_state_transaction_preflight_source_binding_hotfix_patch296r"
KERNEL_PATCH_ID = "Patch 296R — MEA Transaction Trace Source-Binding Hotfix"
...
class ForgeDiscoveryKernelFoundation:
    ...
    def identity(self) -> Dict[str, Any]:
        return {
            ...
            "initial_seed_persistence_only": True,
            "candidate_driven_manifest_advance_active": False,
            ...
            "manifest_persistence_scope": "controlled_initial_seed_only_no_candidate_advance",
            "score_can_rank": True,

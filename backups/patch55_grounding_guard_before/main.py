...
def _print_banner(session_id: str, scope: list[str]):
    ...
    print("│  Phase D Grounded Patch Proposal Preflight.       │")
    print("│  retrieval before coding | source-grounded patches│")
    print("└─────────────────────────────────────────────────────┘")
...
FORGE_EXPECTED_COMMANDS = [
    ...
    "patch-propose", "patch-propose-grounded", "patch-review", "patch-preflight", "patch-apply",
    ...
    try:
        while True:
            ...
            if user_input.lower() == "patch-propose-grounded":
                ...
                print("  Usage: patch-propose-grounded <target_file>")
                print("  Example: patch-propose-grounded ~/forge/main.py")
                print("  Purpose: read target file, search context, and show source-grounded rationale before coding.")
                print()
                continue
            ...
            if user_input.lower() == "help":
                ...
                print("    patch-propose-grounded <file> ← search context before a serious patch")

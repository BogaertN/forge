...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Search the local vector knowledge base for information about the project. "
                "Call this FIRST before reading individual files — it is faster and finds "
                "relevant context across the entire indexed codebase. "
                "Only available after 'forge add <path>' has been run."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "The search query. Use plain language or code terms."
                    },
                    "n_results": {
                        "type": "integer",
...
def dispatch(tool_name: str, args: dict) -> dict:
    ...
    if tool_name == "list_allowed_folders":
        ...
        return _err(
            ...
            "Available: list_allowed_folders, list_files, read_file, search_text, search_knowledge_base"
        )

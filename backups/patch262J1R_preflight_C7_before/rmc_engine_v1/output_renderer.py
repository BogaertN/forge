...
ENGINE_VERSION = "rmc_output_renderer_v1_patch262J1R_preflight_C5"
...
def _render_text(mu: dict[str, Any], audience: str, style: str) -> str:
    claim = _text(mu.get("claim"), 1600)
...
def _build_render_content(packet: dict[str, Any], mu: dict[str, Any], mode: str, audience: str, style: str) -> Any:
    if mode == "json_packet":
    ...
    return _render_text(mu, audience, style)
...
def render_manifest(manifest_report: dict[str, Any], audience_profile: str = "operator", style_mode: str = "standard", render_mode: str = "text") -> dict[str, Any]:
    ...
    rendered = _build_render_content(packet, mu, mode, audience, style)

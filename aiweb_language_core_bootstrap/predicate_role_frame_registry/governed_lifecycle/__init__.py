"""Explicit Slice 38B predicate-governance surface.

Importing this package registers nothing and performs no validation, lookup,
transition, persistence, routing, or runtime activation.  Callers must
construct exact immutable records and invoke the exported pure validators.
"""
...
from .rules import PREDICATE_LIFECYCLE_TRANSITION_RULES, transition_rule
from .schema import (

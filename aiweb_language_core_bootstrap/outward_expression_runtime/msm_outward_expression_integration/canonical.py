"""Deterministic canonical encoding for Slice 42G records."""
...
class MsmOutwardExpressionCanonicalizationError(TypeError):
    """Raised when a value is outside the admitted canonical value domain."""
...
def canonical_value(value: Any) -> Any:
    ...
    if value is None or type(value) in (str, int, bool):
        return value
    raise MsmOutwardExpressionCanonicalizationError(

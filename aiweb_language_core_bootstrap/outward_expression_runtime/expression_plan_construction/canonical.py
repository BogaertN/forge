"""Canonical serialization and deterministic digests for Slice 42E."""
...
class ExpressionPlanCanonicalizationError(ValueError):
...
def _normalize(value: Any) -> Any:
    ...
    if isinstance(value, Mapping):
        if any(type(key) is not str for key in value):
            raise ExpressionPlanCanonicalizationError(

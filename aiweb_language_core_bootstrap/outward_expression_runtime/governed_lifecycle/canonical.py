"""Canonical serialization and SHA-256 helpers for Slice 42B."""
...
class OutwardExpressionCanonicalizationError(ValueError):
...
def canonical_field_order(record_type: type[Any]) -> tuple[str, ...]:
    try:
        ...
        raise OutwardExpressionCanonicalizationError(
...
def stable_identifier(
    ...
    *,
    ...
    if (
        ...
        raise OutwardExpressionCanonicalizationError("invalid namespace")
    return (
        f"{namespace}:"

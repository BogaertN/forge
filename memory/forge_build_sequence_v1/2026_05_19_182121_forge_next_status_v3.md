...
- **recommended_next_patch**: `Patch 154 — Dashboard v2 / Operator Control Panel`
...
- **shadow_restore_run_status**: `FORGE_SHADOW_RESTORE_RUN_WITH_PROBLEMS`
- **shadow_restore_diff_status**: `FORGE_SHADOW_RESTORE_FORENSIC_DIFF_WITH_PROBLEMS`
...
- **S18** — `NEXT` — Dashboard v2 / operator control panel: Future operator-facing dashboard expansion after snapshot foundations.
...
- **S17C** — `ACTIVE` — Shadow Restore / Forensic Diff: Future patch should rehearse restore into a shadow directory and produce forensic diff evidence.
...
## Next Commands
- `forge-shadow-restore-plan latest`

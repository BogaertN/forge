...
- **recommended_next_patch**: `Patch 153 — Shadow Restore / Forensic Diff`
...
- **S17B** — `ACTIVE` — Snapshot Create / Verify: Patch 152 should create Forge-owned snapshot artifacts and verify hashes.
- **S17C** — `NEXT` — Shadow Restore / Forensic Diff: Future patch should rehearse restore into a shadow directory and produce forensic diff evidence.

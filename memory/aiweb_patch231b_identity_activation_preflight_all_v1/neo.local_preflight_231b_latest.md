...
- `PASS` `rmc_namespace_exists` — /home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local
- `PASS` `rmc_namespace_children_exist` — [{'name': 'manifests', 'path': '/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local/manifests', 'exists': True, 'is_dir': True, 'file_count': 0}, {'name': 'receipts', 'path': '/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local/receipts', 'exists': True, 'is_dir': True, 'file_count': 0}, {'name': 'echo', 'path': '/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local/echo', 'exists': True, 'is_dir': True, 'file_count': 0}, {'name': 'private_context', 'path': '/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local/private_context', 'exists': True, 'is_dir': True, 'file_count': 0}, {'name': 'phase_records', 'path': '/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local/phase_records', 'exists': True, 'is_dir': True, 'file_count': 0}]
- `PASS` `rmc_namespace_under_allowed_root` — namespace=/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local allowed=/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents
...
- Resolved path: `/home/nic/aiweb/runtime_wrappers/ancestral_memory/agents/neo.local`

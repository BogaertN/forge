...
- functions_mentioned: `_log, Web, Memory, Persistence, Engine, Symbolic, Output, Stack, engine, symbolic, output, phase, transitions, agent, messages, and, ERROR, write, stack, Expecting, value, line, column, test, init, timestamp, data, version, locked, runtime, stores, Frozen, The, during`

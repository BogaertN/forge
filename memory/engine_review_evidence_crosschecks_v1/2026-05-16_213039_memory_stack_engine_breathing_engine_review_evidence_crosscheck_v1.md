...
- functions_mentioned: `_log, write_to_stack, read_stack, Web, Memory, Persistence, Engine, Symbolic, Output, Stack, engine, symbolic, output, engines, phase, transitions, classifications, and, appends, ERROR, Failed, write, stack, Expecting, value, test, init, timestamp, data, does, loop, version`

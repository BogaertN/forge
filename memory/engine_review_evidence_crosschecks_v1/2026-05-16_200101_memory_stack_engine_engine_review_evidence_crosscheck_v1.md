...
- functions_mentioned: `_log, write_to_stack, read_stack, Web, Memory, Engine, Symbolic, Output, Stack, engine, symbolic, output, from, engines, phase, transitions, classifications, and, ERROR, write, stack, test, event, timestamp, data, version, status, stable, locked, events, stores, Frozen, The, during, recursion`

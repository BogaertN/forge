...
- functions_mentioned: `resurrect_loop, timestamp, resurrected, Loop, Resurrection, Engine, engine, unresolved, loops, from, symbolic, cold, archive, into, active, runtime, queue, for, attempted, resurrection_core, Logic, resurrection_queue, json, Queue, file, previously, archived, resurrection, attempts`

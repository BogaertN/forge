...
- functions_mentioned: `_log, Web, Memory, Persistence, Engine, Symbolic, Output, Stack, engine, symbolic, output, phase, transitions, tier, classifications, and, ERROR, write, stack, Expecting, value, line, column, test, event, data, not, Tier, TIER, loop, version`

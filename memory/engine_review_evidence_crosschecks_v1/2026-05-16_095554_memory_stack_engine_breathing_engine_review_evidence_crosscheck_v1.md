...
- functions_mentioned: `_log, write_to_stack, read_stack, Web, Memory, Persistence, Engine, Symbolic, Stack, engine, symbolic, from, other, engines, phase, transitions, agent, messages, and, appends, ERROR, write, stack, Expecting, value, line, column, test, init, timestamp, data, loop, version, status, stores`

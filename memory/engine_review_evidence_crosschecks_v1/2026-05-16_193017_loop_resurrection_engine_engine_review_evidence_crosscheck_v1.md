...
- functions_mentioned: `resurrect_loop, Loop, Resurrection, Engine, engine, unresolved, loops, from, symbolic, cold, archive, into, active, runtime, queue, for, reintegration, resurrection_core, resurrection_queue, json, Queue, file, Queues, archived, resurrection`
- imports_mentioned: `import json, from resurrection_core import resurrect_loop`
- classes_mentioned: `none`
- file_names_mentioned: `resurrection_core.py, resurrection_queue.json, README.md, engine_manifest.json`

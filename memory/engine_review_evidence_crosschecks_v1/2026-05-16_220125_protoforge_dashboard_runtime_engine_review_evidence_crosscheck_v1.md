...
- functions_mentioned: `System, document, res, json, data, phase, simulate, text, err, error, Drift, Symbolic, meta, Gilligan, Breathing, Dashboard, Breather`
...
- file_names_mentioned: `test_ui_render.py, gilligan_logic.py, test_log.txt, ui_server.py, engine_manifest.json`

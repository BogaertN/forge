...
- functions_mentioned: `_log, write_to_stack, read_stack, Web, Memory, Persistence, Engine, Symbolic, Output, Stack, engine, symbolic, output, from, engines, phase, transitions, classifications, messages, and, ERROR, write, stack, Expecting, value, line, column, test, event, init, timestamp, data, version, stable, locked, events, runtime, stores, Frozen, The`

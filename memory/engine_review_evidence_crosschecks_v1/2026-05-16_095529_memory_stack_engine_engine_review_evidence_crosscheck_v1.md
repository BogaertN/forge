...
- functions_mentioned: `_log, write_to_stack, read_stack, Web, Memory, Engine, Symbolic, Output, Stack, engine, symbolic, output, engines, phase, transitions, agent, messages, and, appends, ERROR, write, stack, test, event, timestamp, data, version, locked, events, runtime, stores, Frozen, The, during, recursion`

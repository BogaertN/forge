...
- functions_mentioned: `resurrect_loop, timestamp, Loop, Resurrection, Engine, engine, unresolved, loops, from, symbolic, cold, archive, into, active, runtime, queue, for, reintegration, resurrection_core, Logic, resurrection_queue, json, Queue, file, status, build_mode, previously, archived, resurrection`

...
## Counts
- canonical_engines: 55
- relationship_rows: 55
- total_detected_edges: 88
- high_risk_neighbors: 0
- medium_risk_neighbors: 6
- engines_with_test_issues: 1
...
- test_status: `ISSUES`
- neighbors:
  - recursive_field_breather — python_import_reference (strong)
  - protoforge — source_text_reference (medium)
...
## Risk Neighbors
- stack_linker_breather: MEDIUM — test_status=ISSUES; relationship_count=2

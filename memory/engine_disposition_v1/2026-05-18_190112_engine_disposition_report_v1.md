...
- `runtime_wrapper_or_stack_deferred`: `7`
...
- `stack_linker_breather` → `runtime_wrapper_or_stack_deferred` | `DEFERRED` | `aiweb/engines/stack_linker_breather`

...
- **active_patch**: `Patch 167 — Runtime Live Build Approval Capture / Execution Gate`
- **current_phase**: `S19M — Runtime Live Build Approval Capture / Execution Gate`
- **next_patch**: `Patch 168 — Runtime Live Build Approval Receipt / Execution Decision Gate`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19M — Runtime Live Build Approval Capture / Execution Gate
  - Next: Patch 168 — Runtime Live Build Approval Receipt / Execution Decision Gate
  - Build rows: 40
  - Deferred items: 2
  - Blocked items: 0
...
- **S19M** — `ACTIVE` — Runtime Live Build Approval Capture / Execution Gate
- **S19N** — `NEXT` — Runtime Live Build Approval Receipt / Execution Decision Gate
...
- `Install Patch 168 — Runtime Live Build Approval Receipt / Execution Decision Gate when ready`

...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19G — Runtime Candidate Static Verification / Live Build Gate
  - Next: Patch 162 — Runtime Live Build Preflight / Human Approval Gate
  - Build rows: 34
  - Deferred items: 2
  - Blocked items: 0
...
- **S19G** — `ACTIVE` — Runtime Candidate Static Verification / Live Build Gate
- **S19H** — `NEXT` — Runtime Live Build Preflight / Human Approval Gate
...
- `Install Patch 162 — Runtime Live Build Preflight / Human Approval Gate when ready`

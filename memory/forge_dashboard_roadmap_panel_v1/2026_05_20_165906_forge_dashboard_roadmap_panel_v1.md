...
- **active_patch**: `Patch 170 — Runtime Live Build Approval Token Validation / Final Execution Preflight`
- **current_phase**: `S19P — Runtime Live Build Approval Token Validation / Final Execution Preflight`
- **next_patch**: `Patch 171 — Runtime Live Build Explicit Approval Capture / Apply Hold`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19P — Runtime Live Build Approval Token Validation / Final Execution Preflight
  - Next: Patch 171 — Runtime Live Build Explicit Approval Capture / Apply Hold
  - Build rows: 43
  - Deferred items: 2
  - Blocked items: 0
...
- **S19P** — `ACTIVE` — Runtime Live Build Approval Token Validation / Final Execution Preflight
- **S19Q** — `NEXT` — Runtime Live Build Explicit Approval Capture / Apply Hold
...
- `Install Patch 171 — Runtime Live Build Explicit Approval Capture / Apply Hold when ready`

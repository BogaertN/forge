...
- **active_patch**: `Patch 169 — Runtime Live Build Human Approval Token Entry Gate`
- **current_phase**: `S19O — Runtime Live Build Human Approval Token Entry Gate`
- **next_patch**: `Patch 170 — Runtime Live Build Approval Token Validation / Final Execution Preflight`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19O — Runtime Live Build Human Approval Token Entry Gate
  - Next: Patch 170 — Runtime Live Build Approval Token Validation / Final Execution Preflight
  - Build rows: 42
  - Deferred items: 2
  - Blocked items: 0
...
- **S19O** — `ACTIVE` — Runtime Live Build Human Approval Token Entry Gate
- **S19P** — `NEXT` — Runtime Live Build Approval Token Validation / Final Execution Preflight
...
- `Install Patch 170 — Runtime Live Build Approval Token Validation / Final Execution Preflight when ready`

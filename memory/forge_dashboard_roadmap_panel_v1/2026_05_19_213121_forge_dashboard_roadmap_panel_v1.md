...
- **active_patch**: `Patch 164 — Runtime Live Build Backup / Apply Dry Run`
- **current_phase**: `S19J — Runtime Live Build Backup / Apply Dry Run`
- **next_patch**: `Patch 165 — Runtime Live Build Final Approval / Live Apply Gate`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19J — Runtime Live Build Backup / Apply Dry Run
  - Next: Patch 165 — Runtime Live Build Final Approval / Live Apply Gate
  - Build rows: 37
  - Deferred items: 2
  - Blocked items: 0
...
- **S19J** — `ACTIVE` — Runtime Live Build Backup / Apply Dry Run
- **S19K** — `NEXT` — Runtime Live Build Final Approval / Live Apply Gate
...
- `Install Patch 165 — Runtime Live Build Final Approval / Live Apply Gate when ready`

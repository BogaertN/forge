...
- **active_patch**: `Patch 168 — Runtime Live Build Approval Receipt / Execution Decision Gate`
- **current_phase**: `S19N — Runtime Live Build Approval Receipt / Execution Decision Gate`
- **next_patch**: `Patch 169 — Runtime Live Build Human Approval Token Entry Gate`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19N — Runtime Live Build Approval Receipt / Execution Decision Gate
  - Next: Patch 169 — Runtime Live Build Human Approval Token Entry Gate
  - Build rows: 41
  - Deferred items: 2
  - Blocked items: 0
...
- **S19N** — `ACTIVE` — Runtime Live Build Approval Receipt / Execution Decision Gate
- **S19O** — `NEXT` — Runtime Live Build Human Approval Token Entry Gate
...
- `Install Patch 169 — Runtime Live Build Human Approval Token Entry Gate when ready`

...
- **active_patch**: `Patch 160 — Runtime Candidate File Draft / Sandbox Candidate`
- **current_phase**: `S19F — Runtime Candidate File Draft / Sandbox Candidate`
- **next_patch**: `Patch 161 — Runtime Candidate Static Verification / Live Build Gate`
- **panel_count**: `4`
...
- **S19F** — `ACTIVE` — Runtime Candidate File Draft / Sandbox Candidate
- **S19G** — `NEXT` — Runtime Candidate Static Verification / Live Build Gate
...
- `Install Patch 161 — Runtime Candidate Static Verification / Live Build Gate when ready`

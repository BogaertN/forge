...
- **active_patch**: `Patch 162 — Runtime Live Build Preflight / Human Approval Gate`
- **current_phase**: `S19H — Runtime Live Build Preflight / Human Approval Gate`
- **next_patch**: `Patch 163 — Runtime Live Build Approval Token / Apply Plan`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19H — Runtime Live Build Preflight / Human Approval Gate
  - Next: Patch 163 — Runtime Live Build Approval Token / Apply Plan
  - Build rows: 35
  - Deferred items: 2
  - Blocked items: 0
...
- **S19H** — `ACTIVE` — Runtime Live Build Preflight / Human Approval Gate
- **S19I** — `NEXT` — Runtime Live Build Approval Token / Apply Plan
...
- `Install Patch 163 — Runtime Live Build Approval Token / Apply Plan when ready`

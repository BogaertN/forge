...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19A — AI.Web Runtime Build Readiness Map
  - Next: Patch 156 — Runtime Module Dependency Map
  - Build rows: 29
  - Deferred items: 2
  - Blocked items: 0
...
- **S19A** — `ACTIVE` — AI.Web Runtime Build Readiness Map
- **S19B** — `NEXT` — Runtime Module Dependency Map
- **S19C** — `FUTURE` — Runtime Build Sandbox Planner
...
- `Install Patch 156 — Runtime Module Dependency Map when ready`

...
- **active_patch**: `Patch 163 — Runtime Live Build Approval Token / Apply Plan`
- **current_phase**: `S19I — Runtime Live Build Approval Token / Apply Plan`
- **next_patch**: `Patch 164 — Runtime Live Build Backup / Apply Dry Run`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19I — Runtime Live Build Approval Token / Apply Plan
  - Next: Patch 164 — Runtime Live Build Backup / Apply Dry Run
  - Build rows: 36
  - Deferred items: 2
  - Blocked items: 0
...
- **S19I** — `ACTIVE` — Runtime Live Build Approval Token / Apply Plan
- **S19J** — `NEXT` — Runtime Live Build Backup / Apply Dry Run
...
- `Install Patch 164 — Runtime Live Build Backup / Apply Dry Run when ready`

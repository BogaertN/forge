...
- **active_patch**: `Patch 165 — Runtime Live Build Final Approval / Live Apply Gate`
- **current_phase**: `S19K — Runtime Live Build Final Approval / Live Apply Gate`
- **next_patch**: `Patch 166 — Runtime Live Build Execution Plan / Receipt Gate`
- **panel_count**: `4`

## Panels
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19K — Runtime Live Build Final Approval / Live Apply Gate
  - Next: Patch 166 — Runtime Live Build Execution Plan / Receipt Gate
  - Build rows: 38
  - Deferred items: 2
  - Blocked items: 0
...
- **S19K** — `ACTIVE` — Runtime Live Build Final Approval / Live Apply Gate
- **S19L** — `NEXT` — Runtime Live Build Execution Plan / Receipt Gate
...
- `Install Patch 166 — Runtime Live Build Execution Plan / Receipt Gate when ready`

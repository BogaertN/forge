...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S17C — Shadow Restore / Forensic Diff
  - Next: Patch 154 — Dashboard v2 / Operator Control Panel
  - Build rows: 23
  - Deferred items: 2
  - Blocked items: 0
...
- **S18** — `NEXT` — Dashboard v2 / operator control panel
...
- **S17C** — `ACTIVE` — Shadow Restore / Forensic Diff
...
- `Install Patch 154 — Dashboard v2 / Operator Control Panel when ready`

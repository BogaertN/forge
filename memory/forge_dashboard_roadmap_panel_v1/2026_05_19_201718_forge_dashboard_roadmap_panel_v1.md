...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19E — Runtime Build Sandbox Verification / Candidate File Plan
  - Next: Patch 160 — Runtime Candidate File Draft / Sandbox Candidate
  - Build rows: 32
  - Deferred items: 2
  - Blocked items: 0
...
- **S19E** — `ACTIVE` — Runtime Build Sandbox Verification / Candidate File Plan
- **S19F** — `NEXT` — Runtime Candidate File Draft / Sandbox Candidate
...
- `Install Patch 160 — Runtime Candidate File Draft / Sandbox Candidate when ready`

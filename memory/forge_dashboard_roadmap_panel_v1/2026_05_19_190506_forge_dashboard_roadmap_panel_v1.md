...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S19B — Runtime Module Dependency Map
  - Next: Patch 157 — Runtime Build Plan / First Safe Module Candidate
  - Build rows: 29
  - Deferred items: 2
  - Blocked items: 0
...
- **S17** — `DONE` — Snapshot and forensic replay expansion
- **S18** — `DONE` — Dashboard v2 / operator control panel
...
- **S17B** — `DONE` — Snapshot Create / Verify
- **S17C** — `DONE` — Shadow Restore / Forensic Diff
...
- **S19B** — `ACTIVE` — Runtime Module Dependency Map
- **S19C** — `NEXT` — Runtime Build Sandbox Planner
...
- `Install Patch 157 — Runtime Build Plan / First Safe Module Candidate when ready`

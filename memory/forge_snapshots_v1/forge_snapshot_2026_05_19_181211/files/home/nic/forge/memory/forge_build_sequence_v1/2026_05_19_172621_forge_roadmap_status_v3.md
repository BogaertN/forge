...
- **current_phase**: `S13 — Source Authority Runtime Binder hardening`
- **active_patch**: `Patch 148 — Source Authority Runtime Binder Hardening`
- **next_patch**: `Patch 149 — LLM Patch Proposal v2`
- **recommended_next_patch**: `Patch 149 — LLM Patch Proposal v2`
...
- **S13** — `ACTIVE` — Source Authority Runtime Binder hardening: Bind canonical engines to source-law / implementation / validation documents with stronger gap reporting.
- **S14** — `NEXT` — LLM patch proposal v2: Allow local LLM proposals only inside verified source, scope, tests, rollback, and readiness structure.
...
## Next Commands
- `forge-source-authority-hardening-build`
- `forge-source-authority-hardening-export`
- `forge-status-api-build`
- `forge-dashboard-build`
- `Install Patch 149 when ready`

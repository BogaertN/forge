...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S12 — Dashboard roadmap panel
  - Next: Patch 148 — Source Authority Runtime Binder Hardening
  - Build rows: 19
  - Deferred items: 2
  - Blocked items: 0
...
- **S12** — `ACTIVE` — Dashboard roadmap panel
- **S13** — `NEXT` — Source Authority Runtime Binder hardening
- **S14** — `READY` — LLM patch proposal v2

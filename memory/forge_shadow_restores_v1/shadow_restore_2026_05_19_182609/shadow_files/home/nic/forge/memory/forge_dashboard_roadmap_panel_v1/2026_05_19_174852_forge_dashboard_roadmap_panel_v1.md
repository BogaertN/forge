...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S15 — Live apply eligibility gate v2
  - Next: Patch 151 — Snapshot / Forensic Replay Plan
  - Build rows: 19
  - Deferred items: 2
  - Blocked items: 0
...
- **S13** — `DONE` — Source Authority Runtime Binder hardening
- **S14** — `DONE` — LLM patch proposal v2
- **S15** — `ACTIVE` — Live apply eligibility gate v2
- **S16** — `NEXT` — Snapshot / forensic replay

...
- **roadmap_overview** — `FORGE_BUILD_SEQUENCE_READY` — Roadmap Overview
  - Current: S16 — Snapshot / forensic replay plan
...
- **S15** — `DONE` — Live apply eligibility gate v2
- **S16** — `ACTIVE` — Snapshot / forensic replay plan
- **S17** — `NEXT` — Snapshot create / verify
